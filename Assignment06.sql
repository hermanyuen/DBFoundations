...
-- 2017-01-01,Herman Yuen,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_HYuen')
	 Begin 
	  Alter Database [Assignment06DB_HYuen] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_HYuen;
	 End
	Create Database Assignment06DB_HYuen;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_HYuen;
...
As
	Select Top 10000
	ProductName, InventoryDate, Count As [InventoryCount]
	From Products As P
...
As
	Select Top 10000
	[ManagerName] = M.EmployeeFirstName + ' ' + M.EmployeeLastName, [EmployeeName] = E.EmployeeFirstName + ' ' + E.EmployeeLastName
	From Employees As E
	Join Employees As M
...
As
	Select Top 10000
	C.CategoryID, C.CategoryName, P.ProductID, P.ProductName, P.UnitPrice, I.InventoryDate, I.[Count], E.EmployeeID, 
